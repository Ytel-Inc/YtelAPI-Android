...
public class SharedShortCodeControllerTest extends ControllerTestBase {
    ...
    public void testTestListKeywords() throws Throwable {
        ...
        APICallBackCatcher<String> response = new APICallBackCatcher<String>();
        controller.setHttpCallBack(httpResponse);
        controller.createListKeywordsAsync(page, pagesize, keyword, shortcode, response);
        result = response.getResult();
    ...
    public void testTestListTemplates() throws Throwable {
        ...
        APICallBackCatcher<String> response = new APICallBackCatcher<String>();
        controller.setHttpCallBack(httpResponse);
        controller.createListTemplatesAsync(type, page, pagesize, shortcode, response);
        result = response.getResult();
    ...
    public void testTestListInboundSMS() throws Throwable {
        ...
        APICallBackCatcher<String> response = new APICallBackCatcher<String>();
        controller.setHttpCallBack(httpResponse);
        controller.createListInboundSMSAsync(datecreated, page, pagesize, from, shortcode, response);
        result = response.getResult();
