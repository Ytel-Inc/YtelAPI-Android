...
public class SubAccountController extends BaseController {    
     ...
     * @param    activate    Required parameter: 0 to suspend or 1 to activate
     * @return    Returns the void response from the API call 
     */
    public void createToggleSubaccountStatusAsync(
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                //load all fields for the outgoing API request
                Map<String, Object> _parameters = new HashMap<String, Object>() {
                    private static final long serialVersionUID = -254966690L;
                    {
                        put( "SubAccountSID", subAccountSID );
                        put( "Activate", (activate != null) ? activate.value() : null );
                    }
                };
