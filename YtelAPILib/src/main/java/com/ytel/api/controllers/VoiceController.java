...
public class VoiceController extends BaseController {    
    ...
    private static VoiceController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the VoiceController class 
     */
     ...
     * @return    Returns the void response from the API call 
     */
    public void createViewCallDetailsAsync(
                final String callSid,
                final APICallBack<String> callBack
    ) {
        Runnable _responseTask = new Runnable() {
     ...
     * @param    from    Required parameter: A valid Ytel Voice enabled number (E.164 format) that will be initiating the phone call.
     * @param    to    Required parameter: Please enter multiple E164 number. You can add max 10 numbers. Add numbers separated with comma. e.g : +12223334444,+15556667777
