...
public class DedicatedShortCodeController extends BaseController {    
     ...
     * @return The singleton instance of the DedicatedShortCodeController class 
     */
    public static DedicatedShortCodeController getInstance() {
        if (null == instance) {
